...
### Time to plot the fs
import pylab
dadi.Plotting.plot_single_2d_sfs(fs2dIntergenic,vmin=0.000001,pop_ids=("TIL","BKN"))
pylab.show()
...
params = array([0.01,3,0.1,0.1 ]) # junk values for testing
...
lower_bound = [ 0.00000001, 0.00000001, 0.00000001, 0.00000001]
...
import pylab
pylab.figure()
dadi.Plotting.plot_single_2d_sfs(theta*model,vmin=0.00000000001,pop_ids=("TIL","BKN"))
