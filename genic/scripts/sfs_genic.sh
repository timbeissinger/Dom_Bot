...
#SBATCH -J sfs_genic
#SBATCH -o slurm-log/sfs_genic_%j.out
#SBATCH -p bigmem
#SBATCH -e slurm-log/sfs_genic_%j.err
#SBATCH --nodes=1
...
command1="-bam DATA/LISTS/"$taxon"_list.txt -out /home/beissing/Dom_Bot_Git/TEMP/"$taxon"_genic_10 -doMajorMinor 1 -doMaf 1 -indF DATA/INBREEDING/"$taxon".indF -doSaf 2 -uniqueOnly 0 -anc DATA/TRIP/TRIP.fa.gz -minMapQ $minMapQ -minQ 20 -nInd $nInd -minInd $minInd -baq 1 -ref /group/jrigrp3/bottleneckProject/genomes/Zea_mays.AGPv3.22.dna.genome.fa -GL $glikehood -P $cpu -rf $regionfile"
echo $command1
...
command2="/home/beissing/Dom_Bot_Git/TEMP/"$taxon"_genic_10.saf $n -P $cpu" 
echo $command2
$angsdir/misc/realSFS $command2 > SFS/"$taxon"_genic_10.sfs
